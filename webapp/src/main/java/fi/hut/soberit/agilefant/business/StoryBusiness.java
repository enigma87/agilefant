...
public interface StoryBusiness extends GenericBusiness<Story> {
     ...
     */
    Story create(Story dataItem, Integer backlogId, Integer iterationId, Set<Integer> responsibleIds, List<String> labelNames, Integer portfoliotypeId, Integer productfeatureId)
